...
namespace Planned.Handlers
{
	public partial class BlobFactory
    {
        ...
        static BlobFactory()
        {
            ...
            RegisterHandler("isaAttachmentAttachment", "\"dbo\".\"isaAttachment\"", "\"Attachment\"", new string[] {
                        "\"isaAttachmentID\""}, "Isa Attachment Attachment", "IsaAttachment", "Attachment");
        }
    }
...
function UploadSuccess(key, message) { 
    ...
    public class BlobAdapter
    {
        ...
        public static string ValidationKey
        {
            get
            {
                return "68794FA60BB78A688ABE36B8296ACFD529499F4BEFC67F27AE9DDEA557CFFD953B958AA157E196021" +
                    "477D72E50163D3F8F7E384A45026891C866DFAC900EA58D";
            }
        }
